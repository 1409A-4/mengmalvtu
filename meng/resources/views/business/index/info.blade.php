...
<div class="clearfix">
    <div class="pull-left alert alert-success no-margin">
        ...
        <span style="color:red;">{{ empty(session('error'))? '': session('error')}}</span>
        @if($info['bstatus']==0)
            邮箱未激活！<a href="business/openEmail?email={{ $info['bemail'] }}">激活</a>邮箱，开启入驻审核。
        @elseif($info['bstatus']==1)
            邮箱已激活！入驻审核中。
        @else
            合作 共赢  猛犸旅途
        @endif
        <form action="business/checkCode" method="post" id="fo" mag="{{session('mag')}}" style="display: none">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">

            <fieldset>
                <label class="block clearfix">
                        <span class="block input-icon input-icon-right">
                            <input type="text" class="form-control" placeholder="输入校验码" name="check"/>
                            <i class=" icon-edit "></i>
                        </span>
                </label>
    ...
    <div class="pull-right">
        <span class="green middle bolder">选择配置: &nbsp;</span>
        ...
        <div class="col-xs-12 col-sm-3 center">
            ...
            <div class="profile-contact-info">
                <div class="profile-contact-links align-left">
                    ...
                    <a class="btn btn-link" href="www.mengmalvtu.com">
        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="profile-user-info profile-user-info-striped">
                <div class="profile-info-row">
                    <div class="profile-info-name"> 商号 </div>

                    <div class="profile-info-value">
                        <span class="editable" id="username">{{$info['bname']}}</span>
                    </div>
                </div>
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{$info['bdescribe']}}</span>
                    </div>
                </div>
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{$info['btruename']}}</span>
                    </div>
                </div>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{$info['bidcard']}}</span>
                    </div>
                </div>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{$info['baddress'].$info['bhome']}}</span>
                    </div>
                </div>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{$info['bphone']}}</span>
                    </div>
                </div>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{$info['bemail']}}</span>
                    </div>
                </div>
                ...
                <div class="profile-info-row">
                    ...
                    <div class="profile-info-value">
                        <span class="editable" id="about">{{ $info['betime'] }}</span>
                    </div>
                </div>


                <div class="profile-info-row">
                    <div class="profile-info-name"> 证件照 </div>

                    <div class="profile-info-value">
                        <img src="{{$info['blicence']}}" alt="证件照" width="100" height="50">
            ...
            <div class="center">
                        <span class="btn btn-app btn-sm btn-light no-hover">
                            ...
                            <br />
                            <span class="line-height-1 smaller-90"> 用户意见 </span>
                        </span>
                ...
                <span class="btn btn-app btn-sm btn-primary no-hover">
                            ...
                            <br />
                            <span class="line-height-1 smaller-90"> 通信录 </span>
                        </span>
            </div>
