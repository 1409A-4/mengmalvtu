        ...
        <nav id="sidebar" role="navigation" class="navbar-default navbar-static-side">
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    {{--<li><a href="#"><i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span class="menu-title">打卡管理</span><span class="fa arrow"></span></a>--}}
                        {{--<ul class="nav nav-second-level">--}}
                            {{--<li><a href="admin/daka/index"><i class="fa fa-briefcase"></i><span class="submenu-title">进行打卡</span></a>--}}
                            {{--</li>--}}
                            {{--<li><a href="admin/daka/show"><i class="fa fa-th-large"></i><span class="submenu-title">打卡记录</span></a>--}}
                            {{--</li>--}}
                        {{--</ul>--}}
                    {{--</li>--}}
                    <li><a href="#"><i class="fa fa-send-o fa-fw"><div class="icon-bg bg-green"></div></i><span class="menu-title">订单管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="admin/list/show"><i class="fa fa-briefcase"></i><span class="submenu-title">订单管理</span></a>
                            </li>
                        </ul>
                    </li>
