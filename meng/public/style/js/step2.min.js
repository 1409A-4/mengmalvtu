        ...
        $("#step2Submit").click(function(){
            ...
            $("#labels li").each(function(){
                ...
                $.ajax({
                    ...
                    url:ctx+"/companyLabel/pasteLabelToCompany.json"}).done(function(a){""!=a?window.location.href=ctx+"/c/founder.html":alert("保存失败")})})});