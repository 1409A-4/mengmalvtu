function img_check(a,b,c,d,e,f,g,h,i,j,k){
    ...
    a=$("#"+f),
        ...
        0!=this.AllowExt&&-1==this.AllowExt.indexOf(this.FileExt)?$("#"+g).text("只支持jpg、gif、png、jpeg格式，请重新上传").show():($("#"+g).text("").hide(),
            $.ajaxFileUpload({
                url:b,
                secureuri:!1,
                fileElementId:f,
                ...
                success:function(a){
                    ""!=a?($("#"+k).val(a),
                        $("#"+i+" img").attr("src",ctx+"/"+a),
                        $("#"+h).hide(),
                        $("#"+i).show()):$("#"+g).text("上传失败，请重新上传").show()},
                error:function(){
